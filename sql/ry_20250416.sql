...
insert into sys_menu values('4', '若依官网', '0', '4', 'http://scm.vip', 'menuBlank', 'C', '0', '1', '', 'fa fa-location-arrow', 'admin', sysdate(), '', null, '若依官网地址');
-- 二级菜单
